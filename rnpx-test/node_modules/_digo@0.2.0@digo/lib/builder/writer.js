...
class Writer {
     ...
     */
    write(content, startIndex, endIndex, sourcePath, sourceMap, sourceLine, sourceColumn) {
     ...
     * @param endIndex 要写入的内容的结束索引(从 0 开始)。
     */
    writeFile(file, startIndex, endIndex) {
 ...
 * 表示一个支持源映射的写入器。
 */
class SourceMapWriter extends Writer {
    constructor() {
        super(...arguments);
        /**
         * 当前使用的源映射生成器。
         */
        this.sourceMapBuilder = new sourceMap_1.SourceMapBuilder();
        /**
         * 当前写入的行号。
         */
        this.line = 0;
    ...
    write(content, startIndex = 0, endIndex = content.length, sourcePath, sourceMap, sourceLine, sourceColumn) {
        if (sourceLine == undefined) {
            const loc = location_1.indexToLocation(content, startIndex);
            sourceLine = loc.line;
