 ...
 */
export declare type AsyncCallback = () => Promise<any> | void;
/**
 * 表示一个异步队列。
 * @desc
 ...
 */
export declare class AsyncQueue extends Queue<AsyncCallback> {
    /**
     * 存储当前锁定的次数。
     */
    private _lock;
     ...
     */
    enqueue(callback: AsyncCallback): void;
    /**
     * 从当前队列顶部取出一个回调函数并执行。
     * @return 返回取出的回调函数。如果队列为空或已锁定则返回 undefined。
     */
    dequeue(): AsyncCallback;
    /**
