...
function updateStatus(message) {
    ...
    process.stdout.__proto__.write.call(process.stdout, log_1.ellipsisLog(`\u001b[0J\u001b[90m${progressChar}\u001b[39m ${message}\u001b[1G`));
}
