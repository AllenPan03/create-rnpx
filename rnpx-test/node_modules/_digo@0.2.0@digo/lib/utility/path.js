 ...
 */
function getFileName(path, ext = true) {
 ...
 */
function setFileName(path, value, ext = true) {
 ...
 */
function prependFileName(path, value) {
    return setFileName(path, value + getFileName(path));
}
exports.prependFileName = prependFileName;
/**
 * 在指定路径的文件名后追加内容。
 * @param path 要处理的路径。
 * @param value 要追加的内容。
 ...
 */
function appendFileName(path, value) {
    const base = np.basename(path);
